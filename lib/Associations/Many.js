...
exports.prepare = function (db, Model, associations) {
  Model.hasMany = function () {
    ...
    var association = {
      ...
      hasAccessorAsync    : opts.hasAccessorAsync || ("has" + assocTemplateName + 'Async')
    };
...
function extendInstance(Model, Instance, Driver, association, opts, createInstance) {
  ...
  console.log(association.hasAccessor + promiseFunctionPostfix)

  Object.defineProperty(Instance, association.hasAccessor + promiseFunctionPostfix, {
    value: Promise.promisify(Instance[association.hasAccessor]),
    enumerable: false,
    writable: true
  });

  Object.defineProperty(Instance, association.getAccessor + promiseFunctionPostfix, {
    value: Promise.promisify(Instance[association.getAccessor]),
    enumerable: false,
    writable: true
  });

  Object.defineProperty(Instance, association.setAccessor + promiseFunctionPostfix, {
    value: Promise.promisify(Instance[association.setAccessor]),
    enumerable: false,
    writable: true
  });

  Object.defineProperty(Instance, association.delAccessor + promiseFunctionPostfix, {
    value: Promise.promisify(Instance[association.delAccessor]),
    enumerable: false,
    writable: true
  });

  Object.defineProperty(Instance, association.addAccessor + promiseFunctionPostfix, {
    value: Promise.promisify(Instance[association.addAccessor]),
    enumerable: false,
    writable: true
  });
