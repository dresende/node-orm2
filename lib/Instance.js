...
function Instance(Model, opts) {
  ...
  Object.defineProperty(instance, 'save' + promiseFunctionPostfix, {
    value: Promise.promisify(instance['save']),
    enumerable: false,
    writable: true
  });
  Object.defineProperty(instance, 'remove' + promiseFunctionPostfix, {
    value: Promise.promisify(instance['remove']),
    enumerable: false,
    writable: true
  });

  Object.defineProperty(instance, 'validate' + promiseFunctionPostfix, {
    value: Promise.promisify(instance['validate']),
    enumerable: false,
    writable: true
  });
