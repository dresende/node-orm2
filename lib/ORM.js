...
ORM.prototype.sync = function (constraints, cb) {
	var modelIds = Object.keys(this.models);
	var syncNext = function () {
		if (modelIds.length === 0) {
                        if (constraints) {
                                return this.syncConstraints(cb);
                        } else {
                                return cb();
                        }
		}
...
ORM.prototype.syncConstraints = function (cb) {
	var modelIds = Object.keys(this.models);
	var syncNext = function () {
		if (modelIds.length === 0) {
			return cb();
		...
		this.models[modelId].syncConstraints(function (err) {
			if (err) {
				err.model = modelId;
