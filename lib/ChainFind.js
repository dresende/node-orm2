...
function ChainFind(Model, opts) {
  ...
  chain.findAsync   = Promise.promisify(chain.find);
  chain.firstAsync  = Promise.promisify(chain.first);
  chain.lastAsync   = Promise.promisify(chain.last);
  chain.runAsync    = Promise.promisify(chain.run);
  chain.removeAsync = Promise.promisify(chain.remove);
