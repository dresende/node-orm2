...
exports.prepare = function (Model, associations, association_properties) {
	Model.hasOne = function (name, OtherModel, opts) {
		...
		var association = {
            ...
            foreignField     : opts.foreignField || opts.field || 'id',
		...
		Object.defineProperty(Instance, association.setAccessor, {
			value: function (OtherInstance, cb) {
				OtherInstance.save(function (err) {
                    ...
                    //console.log('Instance.contact_request_id: ' + Instance.contact_request_id);

                    //console.log('assigning assotiation: ' + association.field + ', value: ' + OtherInstance[association.alienField]);

					Instance[association.field] = OtherInstance[association.foreignField];
