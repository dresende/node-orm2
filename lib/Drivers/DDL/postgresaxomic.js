exports.drop = function (driver, opts, cb) {
	var i, queries = [], pending, queries_length;
	...
	pending = queries_length = queries.length;
...
exports.sync = function (driver, opts, cb) {
	...
	var tables_length;
	pending = tables_length = tables.length;
...
function createTableSchema(driver, table, cb) {
	driver.db.query(table.query, function (err) {
		...
		var pending = tables_subqueries_length = table.subqueries.length;

		for (var i = 0; i < table_subqueries_length; i++) {
