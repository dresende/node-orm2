 ...
 * @param opts
 */
exports.connectAsync = function (opts) {
  return Promise.promisify(connect)(opts);
};
...
ORM.prototype.pingAsync = function () {
  return Promise.promisify(this.ping, { context: this })();
};

ORM.prototype.closeAsync = function () {
  return Promise.promisify(this.driver.close, { context: this })();
};
...
ORM.prototype.load = function () {
  ...
  async.eachSeries(filesWithPath, iterator, cb);
};

ORM.prototype.syncPromise = function () {
  var self = this;
  var modelIds = Object.keys(this.models);
  return Promise.each(modelIds, function (id) {
    return Promise.promisify(self.models[id].sync, { context: self })();
  })
};
...
ORM.prototype.dropAsync = function () {
  var self = this;
  var modelIds = Object.keys(this.models);
  return Promise.each(modelIds, function (id) {
    return Promise.promisify(self.models[id].drop, { context: self })();
  })
};
