...
exports.extend = function (Model, Instance, Driver, associations, opts, cb) {
	...
	var associations_length = associations.length;
...
function extendInstance(Model, Instance, Driver, association, opts, cb) {
	...
	Object.defineProperty(Instance, association.hasAccessor, {
		value: function () {
			...
			var instances_length = Instances.length;
	...
	Object.defineProperty(Instance, association.setAccessor, {
		value: function () {
			var Instances = Array.prototype.slice.apply(arguments);
			var cb = (typeof Instances[Instances.length - 1] == "function" ? Instances.pop() : noOperation);
