...
common.createConnection(function (err, db) {
	db.driver.db.query([
		"CREATE TEMPORARY TABLE `test_association_hasmany_remove` (",
		"`id` INT (5) NOT NULL PRIMARY KEY AUTO_INCREMENT,",
		"`name` VARCHAR(100) NOT NULL",
		")"
	].join(""), function () {
		db.driver.db.query([
			"CREATE TEMPORARY TABLE `test_association_hasmany_remove_assocs` (",
			"`test_association_hasmany_remove_id` INT (5) NOT NULL,",
