...
function Instance(Model, opts) {
	...
	var setConnectionId = function (conId) {
		connectionId = conId;
	}
	...
	var saveNew = function (saveOptions, data, cb) {
		...
		opts.driver.insert(opts.table, data, opts.keyProperties, connectionId, function (save_err, info) {
			if (save_err) {
	...
	var removeInstance = function (cb) {
		...
		Hook.wait(instance, opts.hooks.beforeRemove, function (err) {
			...
			opts.driver.remove(opts.table, conditions, connectionId, function (err, data) {
