...
function Instance(Model, opts) {
  ...
  Object.defineProperty(instance, instanceFuncNames.save.promise, {
    value: Promise.promisify(instanceFuncNames.save.callback),
    enumerable: false,
    writable: true
  });
  Object.defineProperty(instance, instanceFuncNames.remove.promise, {
    value: Promise.promisify(instanceFuncNames.remove.callback),
    enumerable: false,
    writable: true
  });
  Object.defineProperty(instance, instanceFuncNames.validate.promise, {
    value: Promise.promisify(instanceFuncNames.validate.callback),
    enumerable: false,
    writable: true
  });
