...
function extendInstance(Model, Instance, Driver, association, opts, createInstance) {
  ...
  Object.defineProperty(Instance, association.hasAccessor, {
    value: function () {
      ...
      console.log('hasAccessor Instances: ' + Instances)
  ...
  Object.defineProperty(Instance, association.hasAccessor + 'Async', {
    value: function () {
      ...
      return new Promise (function(resolve, reject) {
        ...
        if (Driver.hasMany) {
          return Driver.hasMany(Model, association).has(Instance, Instances, conditions, function(err, result) {
        ...
        association.model.find(conditions, options, function (err, foundItems) {
          if (err) return reject(err);
          if (_.isEmpty(Instances)) return resolve(false);
  ...
  Object.defineProperty(Instance, association.getAccessor + 'Async', {
    value: function () {
      ...
      return new Promise (function (resolve, reject) {
        ...
        if (Driver.hasMany) {
          return Driver.hasMany(Model, association).get(Instance, conditions, options, createInstance, function (err, result){
            if (err) return reject(err);
            return resolve(result);
          });
        }
        ...
        cb = null;
        if (cb === null) {
          console.log(association.model.find(conditions, options))
          return association.model.find(conditions, options);
        }

        association.model.find(conditions, options, function(err, result) {
          if (err) return reject(err);
          return resolve (result);
        });
      });
