...
exports.prepare = function (Model, associations) {
	Model.hasMany = function () {
		...
		var association = {
			...
			findAccessor   : opts.getAccessor || ("find" + assocTemplateName),
		};
...
function extendInstance(Model, Instance, Driver, association, opts, createInstance) {
	...
	Object.defineProperty(Instance, association.findAccessor, {
		value: function () {
			var options    = {};
			var conditions = null;
			var order      = null;
			...
			return association.model.find(conditions, options, cb);
		},
		enumerable: false
	});	
	Object.defineProperty(Instance, association.setAccessor, {
		value: function () {
			...
			var cb        = (Instances.length &&
							 typeof Instances[Instances.length - 1] == "function" ? Instances.pop() : null);
